...
@section("js")
    <script>
        ...
        function restore_button_jenis_cucian(id, cabang_id, nama) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                html: "<p>Data akan dipulihkan!</p>" +
                    "<div class='divider'></div>" +
        ...
        function destroy_button_jenis_cucian(id, cabang_id, nama) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                html: "<p>Data yang dihapus permanen tidak dapat dipulihkan kembali!</p>" +
                    "<div class='divider'></div>" +
                                                ...
                                                <div>
                                                    ...
                                                    @if (!$cabang->deleted_at)
                                                        @role("pic")
                                                            ...
                                                            <label for="destroy_button_jenis_cucian" class="btn btn-outline btn-error btn-sm" onclick="return destroy_button_jenis_cucian('{{ $item->id }}', '{{ $item->cabang_id }}', '{{ $item->nama }}')">
                                                                Hapus Permanen
                                                            </label>
                                                        @endrole
                                                    @endif

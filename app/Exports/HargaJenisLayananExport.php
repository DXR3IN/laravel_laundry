    ...
    */
    public function collection()
    {
        return HargaJenisLayanan::query()
            ...
            ->join('jenis_cucian as jp', 'jp.id', '=', 'harga_jenis_layanan.jenis_cucian_id')
            ->where('c.slug', $this->cabang)
            ->orderBy('harga_jenis_layanan.jenis_layanan_id', 'asc')
            ->orderBy('harga_jenis_layanan.jenis_cucian_id', 'asc')
            ->get(['harga_jenis_layanan.*', 'c.slug', 'jl.nama as jenis_layanan', 'jp.nama as jenis_cucian']);
    }

...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if ($user->hasRole('owner')) {
            ...
            return view('dashboard.index', compact('title', 'userRole', 'umr', 'cabang', 'jmlCabang', 'jmlUser', 'transaksiBaru', 'transaksiProses', 'transaksiSiapDiambil', 'transaksiPengantaran', 'transaksiPenjemputan', 'transaksiSelesai', 'transaksiBatal', 'jadwalLayanan', 'pendapatanHari', 'pendapatanBulanan', 'pendapatanTahunan'));
        } elseif ($user->hasRole('manajer_laundry') || $user->hasRole('pegawai_laundry')) {
        ...
        abort(403, 'Role pengguna tidak valid atau belum diatur.');
    }
}

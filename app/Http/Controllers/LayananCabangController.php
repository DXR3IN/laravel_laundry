...
class LayananCabangController extends Controller
{
    ...
    public function indexCabang(Request $request)
    {
        ...
        $jenisPakaian = JenisCucian::where('cabang_id', $cabang->id)->orderBy('created_at', 'asc')->get();
    ...
    public function indexCabangTrash(Request $request)
    {
        ...
        $jenisPakaianTrash = JenisCucian::where('cabang_id', $cabang->id)->onlyTrashed()->orderBy('created_at', 'asc')->get();

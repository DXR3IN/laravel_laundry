...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\Project\l_laundry_management_system\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.links.E:\\Project\\l_laundry_management_system\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'livewire.release_token','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'laravel-pdf.browsershot.node_binary','laravel-pdf.browsershot.npm_binary','laravel-pdf.browsershot.include_path','laravel-pdf.browsershot.chrome_path','laravel-pdf.browsershot.node_modules_path',
'laravel-pdf.browsershot.bin_path','laravel-pdf.browsershot.temp_path','laravel-pdf.browsershot.write_options_to_file','laravel-pdf.browsershot.no_sandbox','ide-helper.filename',
...
'debugbar.queries.explain','default.livewire.update','livewire.upload-file',
'livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig',
'landing-page','landing-page.nota','login','login.attempt','dashboard',
'logout','profile','profile.edit','profile.update','profile.edit.password',
'profile.update.password','cabang','cabang.store','cabang.show','cabang.edit',
'cabang.update','cabang.delete','cabang.trash','cabang.restore','cabang.destroy',
'umr','umr.store','umr.show','umr.edit','umr.update',
'umr.delete','user','user.cabang','user.cabang.create','user.create',
'user.store','user.view','user.edit','user.update','user.edit.password',
'user.update.password','user.delete','user.trash','user.restore','user.destroy',
'user.import','user.export','layanan-cabang','layanan-cabang.cabang','layanan-cabang.trash',
'jenis-layanan','jenis-layanan.store','jenis-layanan.show','jenis-layanan.edit','jenis-layanan.update',
'jenis-layanan.delete','jenis-layanan.trash','jenis-layanan.restore','jenis-layanan.destroy','jenis-layanan.import',
'jenis-layanan.export','jenis-cucian','jenis-cucian.store','jenis-cucian.show','jenis-cucian.edit',
'jenis-cucian.update','jenis-cucian.delete','jenis-cucian.trash','jenis-cucian.restore','jenis-cucian.destroy',
'jenis-cucian.import','jenis-cucian.export','harga-jenis-layanan','harga-jenis-layanan.store','harga-jenis-layanan.show',
'harga-jenis-layanan.edit','harga-jenis-layanan.update','harga-jenis-layanan.delete','harga-jenis-layanan.trash','harga-jenis-layanan.restore',
'harga-jenis-layanan.destroy','harga-jenis-layanan.import','harga-jenis-layanan.export','layanan-prioritas','layanan-prioritas.store',
'layanan-prioritas.show','layanan-prioritas.edit','layanan-prioritas.update','layanan-prioritas.delete','layanan-prioritas.trash',
'layanan-prioritas.restore','layanan-prioritas.destroy','layanan-prioritas.import','layanan-prioritas.export','layanan-tambahan',
'layanan-tambahan.store','layanan-tambahan.show','layanan-tambahan.edit','layanan-tambahan.update','layanan-tambahan.delete',
'layanan-tambahan.trash','layanan-tambahan.restore','layanan-tambahan.destroy','layanan-tambahan.import','layanan-tambahan.export',
'pelanggan','pelanggan.store','pelanggan.show','pelanggan.edit','pelanggan.update',
'pelanggan.delete','pelanggan.import','pelanggan.export','transaksi.owner','transaksi.owner.cabang',
'transaksi.owner.cabang.jadwal','transaksi.owner.view','transaksi.owner.view.layanan','transaksi.owner.cabang.create','transaksi.owner.cabang.store',
'transaksi.owner.cabang.create.ubahJenisCucian','transaksi.owner.cabang.create.ubahJenisLayanan','transaksi.owner.cabang.create.ubahLayananTambahan','transaksi.owner.cabang.create.hitungTotalBayar','transaksi.owner.cabang.edit',
'transaksi.owner.cabang.update','transaksi.owner.cabang.edit.status','transaksi.owner.cabang.update.status','transaksi.owner.cabang.delete','transaksi',
'transaksi.jadwal','transaksi.view','transaksi.view.layanan','transaksi.create','transaksi.store',
'transaksi.create.ubahJenisCucian','transaksi.create.ubahJenisLayanan','transaksi.create.ubahLayananTambahan','transaksi.create.hitungTotalBayar','transaksi.edit',
'transaksi.update','transaksi.edit.status','transaksi.update.status','transaksi.delete','transaksi.cetak-struk',
'laporan.pendapatan.laundry','laporan.pendapatan.laundry.pdf','laporan.pelanggan','laporan.pelanggan.pdf','register','password.request','password.email','password.reset','password.store',
...
'components.dropdown-link','components.input-error','components.input-label','components.kolom-status-transaksi','components.label-input-required',
...
'components.text-input','dashboard','dashboard.auth.login','dashboard.cabang.index','dashboard.harga-jenis-layanan.index',
'dashboard.index','dashboard.jenis-cucian.index','dashboard.jenis-layanan.index','dashboard.laporan.layouts.main','dashboard.laporan.pdf.pelanggan',
'dashboard.laporan.pdf.pendapatan-laundry','dashboard.laporan.pelanggan','dashboard.laporan.pendapatan-laundry','dashboard.layanan-cabang.cabang','dashboard.layanan-cabang.index',
'dashboard.layanan-cabang.trash','dashboard.layanan-prioritas.index','dashboard.layanan-tambahan.index','dashboard.layouts.footer','dashboard.layouts.link',
'dashboard.layouts.main','dashboard.layouts.navbar','dashboard.layouts.script','dashboard.layouts.sidebar','dashboard.monitoring.index',
'dashboard.monitoring.riwayat','dashboard.monitoring.rw','dashboard.pelanggan.index','dashboard.profile.index','dashboard.profile.ubah',
'dashboard.profile.ubahPassword','dashboard.transaksi.index','dashboard.transaksi.jadwal','dashboard.transaksi.layanan','dashboard.transaksi.lihat',
'dashboard.transaksi.owner.cabang','dashboard.transaksi.owner.index','dashboard.transaksi.owner.jadwal','dashboard.transaksi.owner.layanan','dashboard.transaksi.owner.lihat',
'dashboard.transaksi.owner.tambah','dashboard.transaksi.owner.ubah','dashboard.transaksi.struk.index','dashboard.transaksi.tambah','dashboard.transaksi.ubah',
'dashboard.umr.index','dashboard.user.cabang.index-cabang','dashboard.user.index','dashboard.user.lihat','dashboard.user.owner.index',
'dashboard.user.owner.lihat','dashboard.user.owner.tambah','dashboard.user.owner.ubah','dashboard.user.owner.ubahPassword','dashboard.user.tambah',
'dashboard.user.ubah','dashboard.user.ubahPassword','layouts.app','layouts.guest','layouts.navigation',
'pelanggan.index','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
...
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','E:.Project.l_laundry_management_system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
